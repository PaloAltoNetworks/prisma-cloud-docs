...
| https://github.com/bridgecrewio/checkov/tree/main/checkov/terraform/checks/resource/azure/AkSSecretStoreRotation.py[CKV_AZURE_172]
|MEDIUM
...
| https://github.com/bridgecrewio/checkov/blob/main/checkov/arm/checks/resource/azure/StorageAccountsTransportEncryption.py[CKV_AZURE_3]
|MEDIUM
