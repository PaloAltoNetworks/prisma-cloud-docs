...
+
See https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/get-started-with-prisma-cloud/enable-access-prisma-cloud-console[enable access to the Prisma Cloud Console] for what IP addresses and hostnames for Application security need to be allowed for successfully integrating with Prisma Cloud. 
