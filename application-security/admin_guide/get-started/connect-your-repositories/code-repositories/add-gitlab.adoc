...
+
Your configured GitLab repositories will appear under *Code Repositories* on the *Code & Build Providers* page. On your next GitLab scan, the scan results will include the new configured repositories. Access n xref:../risk-prevention/code/monitor-fix-issues-in-scan.adoc[Projects]to view the scanned results.
