...
+
Your configured GitLab repositories will appear under *Code Repositories* on the *Code & Build Providers* page. On your next GitLab scan, the scan results will include the new configured repositories. Access n xref:../risk-prevention/code/projects.adoc[Projects]to view the scanned results.
...
+
The new integration is displayed in the *Configured Integrations* step of the wizard, and your integrated GitLab Self-managed repositories will appear under *Code Repositories* on the *Code & Build Providers* page. On the next GitLab scan, the results will include the new configured repositories, viewable in xref:../risk-prevention/code/projects.adoc[Projects].
+
...
. Repeat steps *1-2* of <<multi-integrate,Support for multiple integrations>> above > select the menu under *Actions*.
