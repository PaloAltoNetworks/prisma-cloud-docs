...
image:: gitlab-add-integration.png
...
The new integration is displayed in the *Configured Integrations* step of the wizard. Your configured GitLab Self-managed repositories will appear on the *Code & Build Providers* page. On your next GitLab Self-managed scan, the results will include the new configured repositories. Access xref:projects.adoc[Projects] to view the scanned results. 
