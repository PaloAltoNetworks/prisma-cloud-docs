...
+
The *Configure Domain* step of the installation wizard is displayed - see *step 1* above.
+
...
+
The new integration is displayed in the *Configured Integrations* step of the wizard, and your configured GitLab Self-managed repositories will appear under *Code Repositories* on the *Code & Build Providers* page. On your next GitLab Self-managed scan, the results will include the new configured repositories, viewable in xref:../risk-prevention/code/projects.adoc[Projects].
+
