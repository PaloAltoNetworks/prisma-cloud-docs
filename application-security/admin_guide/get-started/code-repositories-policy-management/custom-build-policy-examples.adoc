...
* <<_cloudformation-examples, CloudFormation Examples>>
* <<_secrets-examples, Secrets Examples>>
* <<_kubernetes-examples, Kubernetes Examples>>
...
You can define Secrets signatures using the following format.

[source,yaml]
----
metadata:
  guidelines: "Don't commit this secret"
  category: "secrets" 
definition: 
  cond_type: "secrets"
  value:
...
* <<_k8s-basic-policy-definition, Basic Policy Definition>>
* <<_k8s-connection-state, Connection State>>

[#_k8s-basic-policy-definition]
==== Basic Policy Definition
