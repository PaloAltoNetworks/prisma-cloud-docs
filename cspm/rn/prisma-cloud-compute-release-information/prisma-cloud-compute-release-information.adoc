...
The current *Compute* version is 22.06.229. It will be upgraded to 22.12.427 starting January 22, 2023. 
// To see the new capabilities and changes planned in <month> 2023, see the xref:look-ahead-planned-updates-prisma-cloud-compute.adoc[Prisma Cloud Compute Look Ahead].
