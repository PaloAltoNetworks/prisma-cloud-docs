...
The current *Compute* version is 22.12.694. 
It will be upgraded to 30.00.xxx in end April 2023. 
To see the new capabilities and changes planned in April 2023, see the xref:look-ahead-planned-updates-prisma-cloud-compute.adoc[Prisma Cloud Compute Look Ahead].
