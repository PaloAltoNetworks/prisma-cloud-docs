...
The current *Compute* version is 22.06.229. To see the new capabilities and changes planned in January 2023, see the xref:look-ahead-planned-updates-prisma-cloud-compute.adoc[Prisma Cloud Compute Look Ahead].

//It will be upgraded to 22.12.415 on December 13, 2022.
