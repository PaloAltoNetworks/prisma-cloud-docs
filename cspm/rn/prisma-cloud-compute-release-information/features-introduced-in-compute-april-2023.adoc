...
NOTE: With this release, Defenders running versions 22.01 or earlier will no longer be able to connect to the console. 
...
|*Pagination Support for Cloud Discovery API Endpoint*
