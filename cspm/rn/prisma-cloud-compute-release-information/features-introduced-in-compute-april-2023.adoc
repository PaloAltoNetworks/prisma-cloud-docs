...
This includes a change in request and response schema. For more information, see https://pan.dev/prisma-cloud/api/cwpp/get-cloud-discovery/[the new parameters].
