...
The request and response schema of this API have been updated to implement this change. The *entities* in *GET, /api/vVERSION/cloud/discovery* is moved to another endpoint *GET, /api/v1/cloud/discovery/entities*. For more information, see https://pan.dev/prisma-cloud/api/cwpp/30-00/get-cloud-discovery/[the new parameters].
