...
//RLP-104114
|*-*
|Configure additional NAT IP addresses to reach the Prisma Cloud console in `us-east1`

Add the following egress IP addresses to your environment for it to reach the Prisma Cloud console running in the `us-east1` region.
