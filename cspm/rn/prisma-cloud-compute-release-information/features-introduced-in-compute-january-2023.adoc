...
|Added a new field value *tasFoundations* under *Manage > Defenders > Defenders: Deployed* in the Prisma Cloud Compute user interface to filter Defenders by TAS Foundation ID.
