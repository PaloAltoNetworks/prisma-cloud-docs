...
|RLP-84161 [Audit Logs forward to external integration]

|*Place holder*

|RLP-89582 [Command Center > Vulnerability Swimlane]

|*Place Holder*

|RLP-88309 [Support permission level in Azure - IAM]
...
|RLP-82663 [Audit Logs forward to external integration]

|*Place holder*

|RLP-90592 [Command Center > Vulnerability Swimlane]

|*Place holder*

|RLP-75685 - [on-boarding and data-settings for Azure GA]
