...
|*New Filter in Alerts Overview*
//RLP-90184

|A new *Asset Class* filter is available on the Alerts Overview page that allows you to filter alerts based on the following asset classes supported in Prisma Cloud:
