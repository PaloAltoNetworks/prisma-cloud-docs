...
//RLP-93249
|Prisma Cloud now supports the ISO/IEC 27002:2013 compliance standard.

ISO/IEC 27002:2013 provides guidelines for organizational information security standards and information security management practices, including the selection, implementation, and management of controls while taking the organization's information security risk environment into account.
...
|*RLP-94019 - API Documentation - Alibaba Cloud Account Updates*
|Placeholder
