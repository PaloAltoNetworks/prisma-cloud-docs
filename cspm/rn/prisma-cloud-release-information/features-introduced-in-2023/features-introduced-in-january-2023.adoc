...
|The following new query parameters are added to the existing https://prisma-pan-dev/api/cloud/cspm/compliance-posture#operation/get-compliance-posture[GET/compliance/posture] endpoint.
...
The following new query parameters are added to the existing https://prisma.pan.dev/api/cloud/cspm/compliance-posture/[GET/compliance/posture/trend] endpoint.
...
The following new query parameters are added to the existing https://prisma.pan.dev/api/cloud/cspm/compliance-posture/[GET/compliance/posture/v2/inventory] endpoint.
...
The following new query parameters are added to the existing https://prisma.pan.dev/api/cloud/cspm/compliance-posture/[GET/compliance/posture/v2/inventory/trend] endpoint.

* Every resource on the trend line has two additional attributes:
** screen:[informationalSeverityFailedResources]
** screen:[criticalSeverityFailedResources]

The following new query parameters are added to the existing https://prisma.pan.dev/api/cloud/cspm/compliance-posture/[GET/compliance/resource/scan_info] endpoint.
