...
To ensure continuous insights into all of your GCP resources and to prevent rate limit exception errors, follow the steps listed in the prerequisites to onboard https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/connect-your-cloud-platform-to-prisma-cloud/onboard-gcp/prerequisites-to-onboard-gcp#_prerequisites_to_onboard_gcp_organizations_and_projects_rate-limit-exception-for-gcp-apis[GCP] and make sure to complete them. 
