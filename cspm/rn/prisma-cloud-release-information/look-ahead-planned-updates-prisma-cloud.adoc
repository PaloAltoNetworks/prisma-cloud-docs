...
The rollout will start on October 18, 2023 through early February 2024, and your specific tenant will be updated with the new intuitive user interface and a https://live.paloaltonetworks.com/t5/prisma-cloud-presentations/prisma-cloud-evolution-amp-transformation/ta-p/554059[rich set of security capabilities] during this period. 

Here is the roll out schedule for all Prisma Cloud environments except app.gov, and we hope you're excited! Please connect with your Customer Success team for more details.

* 23.10.2 ((Oct 18-26)  - GA; all new Prisma Cloud customers get the Darwin release
