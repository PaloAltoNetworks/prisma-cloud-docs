...
*Impact—* Low. Existing alerts will be resolved as *Policy_Updated* when the userinput:[vulnerabilityAssessments[*\].properties.storageContainerPath] does not exist.
