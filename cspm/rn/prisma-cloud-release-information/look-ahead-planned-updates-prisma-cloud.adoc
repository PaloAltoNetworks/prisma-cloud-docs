...
|The _/login_ API will be rate-limited and exceeding that limit will return a 429 HTTP status.
...
|*Placeholder for updates to 23.6.1 Policy RQL and/or Metadata*
//RLP-
...
This API is updated to remove a [.] (dot) from the end of the userinput:[resourceRecordSet[*].name] field.
