...
|This policy identifies instances installed with OpenSSL version vulnerable for Spooky SSL: OpenSSL X.509 email address 4-Byte buffer overflow vulnerability (CVE-2022-3602) and exposed to network traffic from the internet. It is recommended to upgrade the OpenSSL version to the latest version and limit exposure to the internet.
