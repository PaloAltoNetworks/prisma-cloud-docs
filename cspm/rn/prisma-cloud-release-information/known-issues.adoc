...
|*RLP-95559* tt:[Fixed in 23.5.1]
//Remove in 6.1
|Prisma Cloud did not support Azurerm versions 3.44.0, 3.45.0, and 3.46.0, which caused an error when you ran the Terraform script during Azure onboarding. Prisma Cloud now supports Azurerm versions 3.44.0, 3.45.0, and 3.46.0.
