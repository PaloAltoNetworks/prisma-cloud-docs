...
|*—* 
//RLP-103813
|Starting with the 23.5.2 release, there are 120 new inactive configuration build policies added and enabled on the console. These policies will be removed in the upcoming releases. Meanwhile, you will not see any alerts or potential issues remediation for these policies. 
