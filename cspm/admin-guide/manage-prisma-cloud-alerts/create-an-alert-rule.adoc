...
[NOTE]
====
 Prisma™ Cloud begins monitoring your cloud environments as soon as you onboard a cloud account, but you must first https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/manage-prisma-cloud-alerts/enable-prisma-cloud-alerts[enable alerting] for each cloud account you onboard before you can receive alerts. Prisma Cloud gives you the flexibility to group your cloud accounts into account groups to limit unrestricted access, these https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/manage-prisma-cloud-administrators/create-account-groups[account groups] must be assigned to an alert, for you to select a group of policies and designate where you want to display the associated Alerts and Notifications for those policies. 
====
