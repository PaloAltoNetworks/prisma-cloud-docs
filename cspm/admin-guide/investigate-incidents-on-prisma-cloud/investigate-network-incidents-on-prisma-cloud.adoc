...
To analyze a specific network traffic of interest, expand the graph to the level of your asset of interest and click on the `_View Details_` link in the sidecar.
