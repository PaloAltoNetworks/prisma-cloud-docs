...
The new Asset Inventory is now available for Prisma Cloud tenants that are onboarded after October 15, 2022. This inventory will be available to all tenants by early 2023.

The Asset Trend visualization (on menu:Inventory[Assets]), now displays 90-day trend information at all times. The Asset Detail View replaces the Resource Explorer experience when traversing asset links throughout Prisma Cloud. The Asset History provides a historical view into the assets within the inventory.
