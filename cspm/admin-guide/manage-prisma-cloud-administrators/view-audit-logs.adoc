...
NOTE: Prisma Cloud does not forward a login successful type audit log messages to external integrations to minimize noise and log flooding. All other audit log types can be forwarded to any supported external integration.
