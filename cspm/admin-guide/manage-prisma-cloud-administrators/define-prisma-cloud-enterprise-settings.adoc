...
+
An email is sent to all administrators notifying them that a System Administrtaor has opted them out. Each administrator can opt back in for themselves on their profile settings. 
