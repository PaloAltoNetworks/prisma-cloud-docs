...
.. Enter *Prisma Cloud Access SAML URL* you copied previously. This is the URL specific to the Prisma Cloud application, which can be used to access Prisma cloud application.
+
