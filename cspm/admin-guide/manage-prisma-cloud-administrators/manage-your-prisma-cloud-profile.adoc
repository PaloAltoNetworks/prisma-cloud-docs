...
+
You can update the default language for the Prisma Cloud administrative console. If you have the System Administrator role, you are subscribed to receive the Prisma Cloud Chronicles. This is a weekly email newsletter that informs you to the 
