...
* Ability to identify vulnerability and compliance issues within the Build phase when applications that are staged for deployment in your continuous cycle of development, testing, and release, or Continous Development pipelines. At this stage, you can enforce policies to ensure only trusted applications are allowed to launch within the cloud runtime environment. 
...
* xref:#use-adoption-advisor[Use Adoption Advisor]
...
+
You must have the System Admin role on Prisma Cloud to access this page.
+
...
Adoption Advisor analyzes your deployment to generate a report that considers your position on the cloud security maturity model. With this report, you can show your stakeholders how adoption progress is currently going in terms of security capabilities at each stage of the application lifecycle, code and build, deploy, and run, in a visual format.

Prisma Cloud administrators with the System Admin role can download the Adoption Advisor PDF report containing a summary of the adoption progress along with a metrics overview of widgets data from the last 30, 60, or 90 days at a regular cadence from the Adoption Advisor console.

System Admins can also set up recurring reports to generate at daily, weekly, or monthly intervals or schedule a one-time PDF report. A list of all the reports can be viewed or managed under "Adoption Advisor > Reports".

Follow the steps below to create and manage the Adoption Advisor report:
...
====
+
image::aa-create-report.png[scale=40]

... Enter the following information:
+
**** Enter a descriptive *Name* for the report.

**** (tt:[Optional]) Enter the *Email Address(es)* for the recipients(s) to receive the reports.
...
+
image::aa-create-view-manage-report.png[scale=40]
+
