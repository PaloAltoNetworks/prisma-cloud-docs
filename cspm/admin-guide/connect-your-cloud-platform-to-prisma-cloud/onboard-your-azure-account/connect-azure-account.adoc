...
.. From the Network Watcher console, navigate to flow logs and complete the following steps:
+
...
.. To view and download these flow logs, follow the steps below:
+
...
... In the container, navigate the folder hierarchy until you get to the *PT1H.json* flowlogs file.
