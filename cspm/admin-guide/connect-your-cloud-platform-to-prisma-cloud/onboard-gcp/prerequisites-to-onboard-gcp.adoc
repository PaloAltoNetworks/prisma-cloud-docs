...
|Project Viewer
|screen:[firebaseauth.configs.get]screen:[identitytoolkit.tenants.list]screen:[firebaseauth.users.get]screen:[identitytoolkit.tenants.list]screen:[identitytoolkit.tenants.getIamPolicy]
|No specific requirement for Prisma Cloud
