...
NOTE:You must add the screen:[cloudtranslate.datasets.list] permission to a custom role as it is a hidden permission in GCP console.
|screen:[cloudtranslate.locations.list]screen:[cloudtranslate.glossaries.list]screen:[cloudtranslate.customModels.list]
|Project where you have created the service account
