...
|DNS Reader
|screen:[dns.dnsKeys.list]screen:[dns.managedZones.list]screen:[dns.projects.get]screen:[dns.policies.list]screen:[dns.managedZones.list]screen:[dns.resourceRecordSets.list]screen:[dns.responsePolicyRules.list]
|Every project that the service account can access
...
|Project Viewer
|screen:[run.locations.list]screen:[run.services.list]screen:[cloudasset.assets.searchAllIamPolicies]screen:[run.jobs.list]screen:[run.jobs.getIamPolicy]
...
|screen:[file.instances.list]screen:[file.snapshots.list]screen:[file.backups.list]
|Every project that the service account can access
...
|screen:[certificatemanager.googleapis.com]
...
|Project Viewer
|screen:[certificatemanager.locations.list]screen:[certificatemanager.dnsauthorizations.list]screen:[certificatemanager.certissuanceconfigs.list]screen:[certificatemanager.certmaps.list]screen:[certificatemanager.locations.list]screen:[certificatemanager.certs.list]
|Every project that the service account can access
