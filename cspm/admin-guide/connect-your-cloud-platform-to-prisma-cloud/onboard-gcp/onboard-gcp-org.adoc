...
If you want to assign child member accounts to different Account Group on Prisma Cloud, you can edit in the Account Group settings later  https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/manage-prisma-cloud-administrators/create-account-groups[Modify Account Group to Include Multiple Cloud Accounts].
+
[NOTE]
====
