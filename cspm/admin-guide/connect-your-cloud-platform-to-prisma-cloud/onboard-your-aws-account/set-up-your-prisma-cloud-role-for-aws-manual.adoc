...
** Select *Require external ID*, paste the *ExternalID* value that you copied in Step 1 above.
...
. Get the granular permissions from the AWS CloudFormation template (CFT) for your AWS environment.
+
...
[NOTE]
====
If you have onboarded your AWS accounts on Prisma Cloud after December 8, 2022, you do not need to download the static CFTs based on the list below. 
