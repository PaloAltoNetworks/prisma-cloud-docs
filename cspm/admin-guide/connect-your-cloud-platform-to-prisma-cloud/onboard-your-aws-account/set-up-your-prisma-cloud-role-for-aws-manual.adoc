...
+
** See xref:add-aws-cloud-account-to-prisma-cloud.adoc#id8cd84221-0914-4a29-a7db-cc4d64312e56[Add an AWS Cloud Account on Prisma Cloud] and follow steps 1-3 to *Download IAM Role CFT*.
