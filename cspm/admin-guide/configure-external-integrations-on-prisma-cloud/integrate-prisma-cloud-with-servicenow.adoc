...
. xref:#idce37e68b-d094-4b6b-a5d4-ab21d092fd36[Set Up Permissions on ServiceNow]
. xref:#idc4548ecb-5da3-4de2-8072-7f0c3df02de3[Enable the ServiceNow Integration on Prisma Cloud]
. xref:#id9e2276cf-c56c-4ea1-a70b-059707fe64b5[Set up Notification Templates]
<<<<<<< HEAD
. xref:#id46a9b2b8-8b2a-4b68-b65e-d8c15dd574d2[View Alerts]

If you see errors, review how to xref:#iddd0aaa90-d099-4a99-a3ed-bde105354340[Interpret Error Messages].
=======
. xref:#id46a9b2b8-8b2a-4b68-b65e-d8c15dd574d2[View Alerts]If you see errors, review how to xref:#iddd0aaa90-d099-4a99-a3ed-bde105354340[Interpret Error Messages].
...
=======
... Select menu:User{sp}Administration[Roles] to create a new role and assign it to the local administrative user you created earlier.

... Pick a table, such as the *Plugins* table, and select the menu (“hamburger”) icon next to a table column header to menu:Configure[Table].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
...
=======
... Select menu:Access{sp}Controls[New].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
...
=======
. Log in to Prisma Cloud and select menu:Settings[Integrations > +Add New].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
...
. Select the Service Type for which you want to generate tickets—*Security*, *Incidents*, and/or *Event*.
+
...
=======
Continue with setting up the notification template, and then verify the status of the integration on menu:Settings[Integrations].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
...
[.procedure]
<<<<<<< HEAD
. Log in to Prisma Cloud and select "Alerts > Notification Templates".
=======
. Log in to Prisma Cloud and select menu:Alerts[Notification Templates].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b

. *Add New* notification template, and choose the template for ServiceNow.
+
image::service-now-notification-template-hub.png[scale=30]
...
. Set the *Service Type* to *Security* ,*Incident* or *Event*.
+
...
. Click *Next* and select the alert status for which you want to set up the ServiceNow fields.
+
...
. Click *Next* to go to the review pane and review your selection.
...
=======
For an on-demand status check, use the *Get Status* icon on menu:Settings[Integrations]. These checks help you validate that the ServiceNow instance URL is reachable and that your credentials are valid.
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
...
=======
.. To view event incidents (events table), select menu:Event{sp}Management[All Events].
>>>>>>> a48f563acd19a503f35c9d080d1ddbd8d19acc9b
+
