...
Required for Code Security integrations, if a network address limit exists.
...
+
api{asterisk}.{asterisk}.prismacloud.io. See https://pan.dev/api/cloud/api-urls[API URLs] for your Prisma Cloud tenant.
