...
For Example, the app3 tenant "https://app3.prismacloud.io/.", will need an Outbound security rule for the following Egress "34.82.51.12" .
For sending Alerts to your environment, you'd want to add an ingress associated with the same Console, in this example it would be "104.198.109.73 " .
Compute requires only an outbound rule to your Console to complete it's work in respect to Agentless and Defender deployments.

To Summarize: Egress-From Defenders to Console; Ingress-From Console in to your environment for alerts.
