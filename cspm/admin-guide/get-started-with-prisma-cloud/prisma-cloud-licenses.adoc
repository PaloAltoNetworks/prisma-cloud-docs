...
If the license is not renewed within the first 90-days of your license expiration (“Grace Period”), your Prisma Cloud tenant is completely deleted. It may take up to 30 days after the Grace Period to permanently delete the data you provided and stored in the Prisma Cloud console and/or API, except in the cases of the Infrastructure as Code module, Software Composition Analysis module and Secret Scanning module, it will take up to 365 days from the last date of scan to permanently delete your data.
//RLP-108664
