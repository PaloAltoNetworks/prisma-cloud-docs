...
** *Prisma Cloud Runtime Security*—Licenses for the runtime security offerings are available with VM-based metering. You can choose from the bundles for Runtime Security Foundations and Runtime Security Advanced, and you can avail of additional capabilities as add-ons.
+
...
+
Runtime Security Foundations and Runtime Security Advanced also includes the option to activate Infrastructure as Code (IaC) Security (formerly known as Code Security) with developer based metering at 3 credits per Developer seat. Available modules include: Software Composition Analysis (SCA), offered at 4 credits per Developer and Secrets Scanning, offered at 1 credit per Developer. 
