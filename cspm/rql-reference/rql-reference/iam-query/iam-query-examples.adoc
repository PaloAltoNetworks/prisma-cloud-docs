...
== IAM Query Examples
Utilize these IAM Query examples to:

1. Learn how to use the userinput:[config from iam where] query to find risky or extra permissions assigned to cloud entities or users.  
2. Learn how simple it is to build your queries and append additional filters to easily customize your search results.
3. Utilize our powerful *Graph* view to help you start with a broad query and easily narrow your search results from there.
...
5. Keep this page bookmarked as more query examples will continue to be added over time.  

Have a query you think would be useful to other customers?  Contribute via our Github page by clicking the *Edit on Github* link above!
