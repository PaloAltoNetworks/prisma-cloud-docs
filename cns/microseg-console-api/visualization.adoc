...
Type: link:../policy/#networkaccesspolicy[`[\]networkaccesspolicy`]
...
Type: link:../policy/#dnslookupreport[`[\]dnslookupreport`]

List of DNSLookupReports.

====== `connectionExceptionReports`

Type: link:../policy/#connectionexceptionreport[`[\]connectionexceptionreport`]

List of ConnectionExceptionReports.

====== `counterReports`

Type: link:../core/#counterreport[`[\]counterreport`]

List of CounterReports.

====== `enforcerReports`

Type: link:../core/#enforcerreport[`[\]enforcerreport`]

List of EnforcerReports.

====== `eventLogs`

Type: link:../core/#eventlog[`[\]eventlog`]

List of EventLogs.

====== `flowReports`

Type: link:../policy/#flowreport[`[\]flowreport`]

List of FlowReports.

====== `packetReports`

Type: link:../core/#packetreport[`[\]packetreport`]
