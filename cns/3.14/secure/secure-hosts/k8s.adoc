...
* Installed the Aporeto enforcer xref:../../../start/enforcer/k8s[as a DaemonSet] or xref:../../../start/enforcer/linux[as a service].
* xref:../../start/apoctl.adoc[Installed `apoctl`].
...
If you have followed the installation instructions as mentioned in <<prerequisites,Prerequisites>>, you have to update your `APOCTL_NAMESPACE` variable like this:
