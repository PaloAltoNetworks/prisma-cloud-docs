...
In this mode, the control plane ceases to serve the xref:../develop/ctrl-plane-api.adoc[Control Plane API] and provides the following output:
...
* From regular call to the xref:../develop/ctrl-plane-api.adoc[Control Plane API]:
...
* From the xref:{{< ctrl-plane-ui-url >}}/app[Aporeto web interface]:
