...
----
[Production cloud install,language-shell]
----
...
----
[Advanced on-premise install,language-shell]
----
...
Refer to the xref:../start/enforcer/linux.adoc#advanced-on-premise-install[installation documentation] for instructions.
====
