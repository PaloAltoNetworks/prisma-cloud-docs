...
Look for a tag that uniquely identifies the web server, persists through time, and matches a xref:../concepts/network-rulesets.adoc#tag-prefixes[tag prefix].
+
