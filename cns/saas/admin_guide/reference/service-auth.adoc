...
image::apiservices-configuration.png[Common enforcer deployment]
...
Refer to xref:../secure/oidc.adoc[OIDC for users of Aporeto-protected applications] for more details.
