...
Review the concept of xref:../concepts/network-rulesets.adoc#tag-prefixes[tag prefixes].
...
Refer to our xref:../concepts/network-rulesets.adoc#networkrulesetpolicy[conceptual overview], xref:../secure.adoc[how to instructions], and the xref:../microseg-console-api/policy.adoc[API reference] to understand the new model.
