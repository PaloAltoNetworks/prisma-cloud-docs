...
Each microservice exposes a xref:../microseg-console-api.adoc[REST API], gathered to a single endpoint by an API gateway.
...
The web interface is a client consuming the xref:../microseg-console-api.adoc[REST API] exposed by the Microsegmentation Console.
