...
* _To deploy the enforcer on GKE, you must have https://cloud.google.com/kubernetes-engine/docs/how-to/iam#predefined[*Kubernetes Engine Admin* permissions]_.
