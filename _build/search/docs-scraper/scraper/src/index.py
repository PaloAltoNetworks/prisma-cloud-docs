...
from .tw_downloader_middleware import TwDownloaderMiddleware
...
def run_config(config):
    ...
    process = CrawlerProcess({
        ...
        'DOWNLOADER_MIDDLEWARES': {DOWNLOADER_MIDDLEWARES_PATH: 900, 'scraper.src.tw_downloader_middleware.TwDownloaderMiddleware': 950},
