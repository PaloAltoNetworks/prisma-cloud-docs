...
class DocumentationSpider(CrawlSpider, SitemapSpider):
    ...
    def __init__(self, config, algolia_helper, strategy, *args, **kwargs):
        ...
        # Twistlock config paths
        self.tw_staging = config.tw_staging
        self.tw_doc_site_url = config.tw_doc_site_url
        self.tw_doc_site_staging_url = config.tw_doc_site_staging_url
        self.tw_doc_site_local = config.tw_doc_site_local
        self.tw_asciibinder_prefix = config.tw_asciibinder_prefix
