...
// #23906
* Adds support for detecting Go binaries in container and host file systems, finding and listing module dependencies, and reporting vulnerabilities in Go releases.
