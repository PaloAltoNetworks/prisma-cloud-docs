...
// #24197 
* Fixes an issue where you could not view view docker or kubectl logs for some container that were launched or restarted in evironments protected by Defender.
