...
* <<xref: #_new-features-in-the-core-platform,New features in the core platform>>

* <<xref: #_new-features-in-container-security,New features in container security>>

* <<xref: #_new-features-in-host-security,New features in host security>>

* <<xref: #_new-features-in-waas,New features in WAAS>>

* <<xref: #_bug-fixes],Addressed issues>>

* <<xref: #_disa-stig], DISA STIG scan findings and justifications>>

* <<xref: #_breaking-changes],Breaking changes>>

* <<xref: #_non-breaking-changes,Changes in existing behavior>>

* <<xref: #_known-issues,Known issues>>

* <<xref: #_end-of-support-notifications, End of support notifications>>
