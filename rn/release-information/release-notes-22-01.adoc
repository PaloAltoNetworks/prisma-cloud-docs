...
* <<_backward_compatibility,New features Backward compatibility limitations >> 
...
=== New features Backward compatibility limitations 

The following table lists new features introduced in this release that will not be supported by old defenders/twistcli/Jenkins plugin.


[cols="25%,25%a,50%", options="header"]
|===
...
|Defenders
|The following new/modified checks will not be supported:
