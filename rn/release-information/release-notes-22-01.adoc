...
Users should retrieve the updated script from their Console and update it in ServiceNow.
...
This fix only takes effect once upgraded to Joule.
...
// #31563
* `twistcli sandbox` now exits with status `1` if the verdict is "failed".
