...
* The v1 version always points to the latest API.
You can continue to use v1 if you plan to always keep your integrations up to date with the latest release.
