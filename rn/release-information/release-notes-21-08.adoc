...
// #30289
* Starting in 21.08, new installations of Compute ship with empty container, host, and serverless runtime policies.
...
Disabling runtime defense lets you postpone runtime defense configuration to a more convenient time.
