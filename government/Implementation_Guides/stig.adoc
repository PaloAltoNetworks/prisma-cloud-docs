...
The proposed settings can be downloaded as a CSV file from https://github.com/PaloAltoNetworks/prisma-cloud-docs/blob/static-site-iverson/government/Implementation_Guides/stig_for_prisma_cloud_compute.csv[here].

== Findings

[format=csv, options="header"]
|===
include::Implementation_Guides/stig_for_prisma_cloud_compute.csv[]
|===
