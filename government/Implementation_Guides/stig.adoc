...
The proposed settings can be downloaded as a CSV file from https://github.com/twistlock/docs/tree/master/government/implementation_guides/stig_for_prisma_cloud_compute.csv[here].
