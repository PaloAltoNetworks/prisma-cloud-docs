...
=== OpenSCAP https://cdn.twistlock.com/docs/attachments/openscap_console_20_12_541.html[report]
...
=== OpenSCAP https://cdn.twistlock.com/docs/attachments/openscap_defender_20_12_541.html[report]
