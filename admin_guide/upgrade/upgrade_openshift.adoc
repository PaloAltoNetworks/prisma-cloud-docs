...
[.procedure]
. Download the xref:../welcome/releases.adoc[latest Twistlock release] to the host where you manage your cluster with _oc_.
...
+
  $ <PLATFORM>/twistcli console export openshift \
    ...
    --service-type "ClusterIP"
+
For other command variations, see the xref:../install/install_openshift.adoc#[OpenShift install guide].
