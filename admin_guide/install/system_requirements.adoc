...
NOTE: When 1001-5,000 Defedners are connected, you may be able to operate with less CPU, RAM and persistent storage for the Console, but it is not officialy supported.
