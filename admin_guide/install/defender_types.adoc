...
xref:../vulnerability_management/pcf_blobstore.adoc#[PCF Defenders] run on your PCF infrastructure and scan the droplets in your blobstores for vulnerabilities.
