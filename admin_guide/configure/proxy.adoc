...
Any Defenders deployed after saving your settings will use your proxy settings, unless you explicitly choose a different proxy when deploying the Defenders.
