...
* _iac_ --
Scan Infrastructure-as-Code (IaC) templates for potential issues and misconfigurations. Learn more about Prisma Cloud https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-code-security/get-started/what-is-code-security[Code Security].
