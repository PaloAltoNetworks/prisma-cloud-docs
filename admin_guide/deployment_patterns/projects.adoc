...
If you've deployed a scale project, see xref:../deployment_patterns/migration_options_for_scale_projects.doc[migration options for scale projects] for more information about how to transition to a supported configuration.
