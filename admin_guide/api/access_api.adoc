...
The Prisma Cloud API is exposed on the host that runs Console on ports 8081 (HTTP) and 8083 (HTTPS).
These ports are specified at install time in _twistlock.cfg_.
The preferred path to the API is over HTTPS on port 8083.
