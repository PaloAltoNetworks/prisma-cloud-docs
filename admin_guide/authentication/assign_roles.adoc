...
Each of the permission groups in platform are mapped to Compute User roles. For more information see xref:../authentication/prisma_cloud_user_roles.adoc[Prisma Cloud User Roles mapping].
