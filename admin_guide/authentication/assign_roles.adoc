...
Starting Hamilton release, you will also be able to type "Account IDs" as string to give additional RBAC access to accounts that are not onboarded in Prisma Cloud. 
