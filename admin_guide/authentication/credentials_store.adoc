...
+
NOTE: For GCP, using onboarded organization accounts is not supported. To use GCP service account for an organization, create GCP credentials within Compute with the *Organization* credential level.
+
