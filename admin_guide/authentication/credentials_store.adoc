...
.. In the *Credential level* field, select the permissions level of the service account. For a single project selet *Project*. For Prisma Cloud to find and scan all the projects in an organization, select *Organization*.
