...
.. If you're running v1.13-1.15 of Kubernetes, copy the YAML from the *Advanced Settings* dialog.
If you're running v1.16 or later of Kubernetes, copy the YAML from  <<_api_v1,Kubernetes v1.16+ webhook template>>.
