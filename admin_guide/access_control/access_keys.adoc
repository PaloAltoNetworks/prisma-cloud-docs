...
When you create an access key in Prisma Cloud (outer interface), the system automatically xref:prisma_cloud_user_roles.adoc[maps] the key to one of the Prisma Cloud Compute roles.
