...
Example:
  ...
  Jul 16 20:10:16 cnaf-nightly-build Twistlock-Defender[1947]: 
    ...
    effect="prevent"
    msg="Detected Local File Inclusion attack in query parameter \"id\": ../etc/passwd"
    log_type="lfi"
    source_ip="87.71.135.166"
    source_country="IL"
    request_method="HEAD"
    request_user_agents="curl/7.54.0"
    request_host="nightly.n3v3rth3l3ss.com"
    request_url="nightly.n3v3rth3l3ss.com/?id=../etc/passwd"
    request_path="/"
    request_query="id=../etc/passwd"
    request_header_names="User-Agent,Accept"
