...
Follow the steps in
xref:../secrets/secrets_stores/hashicorp_vault.adoc#[Integrating Prisma Cloud with HashiCorp Vault].


=== Creating a rule in Console

Follow the steps in
xref:../secrets/inject_secrets.adoc#[Injecting secrets into containers].
