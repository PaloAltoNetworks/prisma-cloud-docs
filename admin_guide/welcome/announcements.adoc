...
=== Upgrade plan for 21.04 update 1
...
IMPORTANT: This is a major upgrade to Hamilton release of Compute and will contain significant new features and breaking changes. Please read through release notes carefully in preparation.
...
. 21.04 update 1 fixes: https://docs.prismacloudcompute.com/docs/releases/release-information/release-notes-21-04-update1.html
