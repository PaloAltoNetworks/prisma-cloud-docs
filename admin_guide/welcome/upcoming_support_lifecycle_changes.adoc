...
* Currently, the Compute https://docs.twistlock.com/docs/compute_edition/welcome/support_lifecycle.html[support lifecycle] is the current major version and the previous major version ("N-1").
...
* Currently, the Compute API is not versioned between releases, though there are a set of APIs which very rarely change documented in our https://docs.twistlock.com/docs/compute_edition/api/stable_api.html[API Stability Guide].
