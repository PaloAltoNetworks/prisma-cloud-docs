...
xref:../authentication/user_roles.adoc#[User roles].
...
* The project's workspace, in the scan results file (by the name configured in the scan steps).

* The https://cdn.twistlock.com/docs/api/twistlock_api.html[Prisma Cloud API].
