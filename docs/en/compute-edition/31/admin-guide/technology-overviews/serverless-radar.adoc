...
To see vulnerability and compliance information in Serverless Radar, configure Prisma Cloud to xref:../vulnerability-management/serverless-functions.adoc[scan] the contents of each function.
