...
Additionally, you can implement your own compliance checks with xref:./custom-compliance-checks.adoc[scripts].
...
Most built-in checks are based on the xref:../compliance/cis-benchmarks.adoc[CIS benchmarks].
...
* Twistlock Labs compliance checks for xref:./prisma-cloud-compliance-checks.adoc[containers, images, Istio, and Linux hosts].
* Twistlock Labs compliance checks for xref:./serverless.adoc[serverless functions].
* Twistlock Labs compliance checks for xref:./windows.adoc[Windows].
