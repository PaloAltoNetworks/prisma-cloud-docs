...
. Click on the workload in the radar and open xref:./deployment-troubleshooting.adoc#connectivity-monitor[`WAAS connectivity monitor`] by clicking on the WAAS tab.
...
. A section of xref:./deployment-troubleshooting.adoc#outcomes[`troubleshooting potential outcomes`] is provided below, along with possible causes and solutions.
...
|Click on `View recent errors` in the xref:./deployment-troubleshooting.adoc#connectivity-monitor[`WAAS connectivity monitor`] to view errors. 
