...
Additionally, you can implement your own compliance checks with xref:../compliance/custom-compliance-checks.adoc[scripts].
...
* Twistlock Labs compliance checks for xref:../compliance/prisma-cloud-compliance-checks.adoc[containers, images, Istio, and Linux hosts].
