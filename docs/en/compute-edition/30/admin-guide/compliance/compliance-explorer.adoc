...
Use the *Category:Prisma Cloud Labs* filter in the table to show the xref:malware.adoc[malware scanning] results obtained using Advanced WildFire after an xref:../agentless-scanning/agentless-scanning.adoc[agentless scan].
