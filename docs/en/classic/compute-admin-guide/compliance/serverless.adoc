...
. Verify that you have assigned the xref:../vulnerability-management/serverless-functions.adoc#authenticating-with-aws[correct permissions] required to scan.
