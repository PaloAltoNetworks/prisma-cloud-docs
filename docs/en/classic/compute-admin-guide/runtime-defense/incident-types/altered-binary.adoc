...
Ensure that compliance benchmarks are appropriately applied to the affected images and containers. Use xref:../../compliance/trusted-images.adoc#[Trusted Images], to avoid image pulls from untrusted sources.
