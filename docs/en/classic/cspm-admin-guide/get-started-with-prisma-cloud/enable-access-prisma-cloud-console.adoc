...
image::access-to-prisma-cloud-visualization.png[scale:10]
...
Required for Application Security integrations with network restrictions, such as self-hosted code environments.
...
Ingress: 104.198.109.73, 34.82.51.12, 34.82.138.152
|34.192.147.35/32
...
+
include::../fragments/id3d308e0b-921e-4cac-b8fd-f5a48521aa03-idd73e7807-44d4-4bc0-b57f-97876da93ad8.adoc[]
...
+
** {asterisk}.bridgecrew.cloud, for the Application Security capabilities that are enabled on the *Code* and *Settings* tab on the Prisma Cloud console.
