...
[TIP]
====
If the Remediable column is not displayed on the page, use the *Column Picker* (image:column-picker.png[]) to display it.
====
+
image::../_graphics/alerts/remediable-policies-1.png[]
