...
[.procedure]
. Click the *View* icon next to the AWS account or organization you want to update.
...
.. Open the downloaded CFT in a text editor, search for `sts:ExternalId` and *Copy* the value.
+
