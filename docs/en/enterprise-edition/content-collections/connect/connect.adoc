...
|xref:../connect/connect-cloud-accounts/connect-cloud-accounts.adoc[Cloud Accounts]
...
|xref:../connect/connect-image-registries/connect-image-registries.adoc[Image Registries]
...
|xref:../connect/connect-code-and-build-providers/connect-code-and-build-providers.adoc[Code and Build Providers]

|Select and Deploy Defenders
//Connect your defenders. Short overview topic with link to Compute topics.
|xref:../connect/deploy-defenders/deploy-defenders.adoc[Defenders]
