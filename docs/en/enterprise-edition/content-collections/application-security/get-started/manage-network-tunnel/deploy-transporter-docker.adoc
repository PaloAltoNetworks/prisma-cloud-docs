...
. In Application Security, select *Home* > *Settings* > *Manage Network Tunnels*.
...
You can add ta new Transporter to an VCS integration in Application Security through *Home* >  *Settings* > *Manage Network Tunnels* > *Manage Integrations* > *New Transporter*.
