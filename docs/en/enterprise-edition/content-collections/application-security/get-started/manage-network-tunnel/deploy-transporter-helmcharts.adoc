...
* Download the Transporter Client Helm chart: The available image tags are located in the Docker Hub repository https://hub.docker.com/r/bridgecrew/transporter/tags[here]
+
...
.. Setup Transporter through the Prisma Cloud console  - see xref:deploy-transporter-docker.adoc[Set Up Transporter Network Tunnels using Docker Containers]. 
