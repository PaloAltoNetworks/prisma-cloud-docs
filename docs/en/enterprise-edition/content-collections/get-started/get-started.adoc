...
Prisma Cloud™'s comprehensive security solution helps you take a platform based, proactive approach to securing your cloud estate from Code to Cloud. Start here to get familiarised with the Prisma Cloud administrative console, available licenses, and common workflows to help you get started. 
