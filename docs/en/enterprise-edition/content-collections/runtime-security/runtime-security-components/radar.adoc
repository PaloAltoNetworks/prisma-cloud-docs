...
image::runtime-security/radar-general.png[width=800]
...
image::runtime-security/radar-zoomed-out.png[width=800]
...
image::runtime-security/radar-zoomed-in.png[width=800]
...
image::runtime-security/radar-k8s-service-account.png[width=600]

Clicking on the service accounts lists the service roles and cluster roles.

image::runtime-security/radar-k8s-service-account-details.png[width=600]
...
image::runtime-security/radar-map-istio.png[width=600]
...
image::runtime-security/waas-radar-monitor.png[width=1000]
...
image::runtime-security/radar-host-pivot.png[width=800]
...
. Select *Runtime Security > Radars > Settings*.
