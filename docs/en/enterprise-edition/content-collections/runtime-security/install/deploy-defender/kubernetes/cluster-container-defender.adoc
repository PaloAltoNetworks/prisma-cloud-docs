...
* You created a xref:../../../authentication/credentials-store/gcp-credentials.adoc[GCP credential] for your cluster so that Prisma Cloud can access it to deploy the Defender DaemonSet:
+
. Log into Prisma Cloud Console.
