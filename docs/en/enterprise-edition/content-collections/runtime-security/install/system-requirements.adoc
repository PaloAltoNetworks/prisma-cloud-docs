...
For information about when Prisma Cloud adds and drops support for third party software, see our xref:../runtime-security/rs-support-lifecycle.adoc#third-party-software[support lifecycle] page.
