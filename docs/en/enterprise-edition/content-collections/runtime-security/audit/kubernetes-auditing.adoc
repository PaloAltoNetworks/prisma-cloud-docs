...
See https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-compute/install/system-requirements[here] for GKE cluster versions supported by Prisma Cloud.
