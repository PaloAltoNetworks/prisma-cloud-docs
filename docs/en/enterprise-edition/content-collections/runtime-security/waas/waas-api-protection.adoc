...
+
image::runtime-security/waas-app-definition.png[width=650]

. Click *Import*.
+
image::runtime-security/waas-import-api.png[width=650]

. Select a file to load.

. Click the *API protection* tab.
+
image::runtime-security/waas-api-protection-tab.png[width=650]

. Review path and parameter definitions listed under *API Resources*.

. Click the *Endpoint setup* tab.
+
image::runtime-security/waas-endpoint-setup-tab.png[width=650]
...
+
image::runtime-security/waas-api-protection-config-actions.png[width=650]
...
+
image::runtime-security/waas-api-protection-action.png[width=650]
...
. Click the *API protection* tab.
+
image::runtime-security/waas-api-protection-tab-empty.png[width=650]

. Click *Add path*

. Enter *Resource path* (e.g. _/product_  - resource paths should not end with a trailing _"/"_).
+
image::runtime-security/waas-api-protection-path-methods.png[width=650]
+
...
+
image::runtime-security/waas-select-methods.png[width=350]

. For each allowed HTTP method, define parameters by selecting the method from *Parameters for* drop-down list.
+
image::runtime-security/cnaf-api-protection-select-method.png[width=350]
...
+
image::runtime-security/cnaf-api-add-parameter.png[width=550]
