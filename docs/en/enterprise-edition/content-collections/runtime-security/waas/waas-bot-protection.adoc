...
image::runtime-security/waas-bot-protection.png[]
...
+
image::runtime-security/waas-known-bots.png[]
...
+
image::runtime-security/waas-unknown-bots.png[]

. Choose <<bot-actions, actions>> for each bot category.

.. If `Request anomalies` are enabled, choose sensitivity threshold
+
image::runtime-security/waas-request-anomalies.png[]
...
+
image::runtime-security/waas-active-bot-detections.png[]
+
...
+
image::runtime-security/waas-captcha-action.png[]
+
...
+
image::runtime-security/waas-captcha-page.png[]
+
