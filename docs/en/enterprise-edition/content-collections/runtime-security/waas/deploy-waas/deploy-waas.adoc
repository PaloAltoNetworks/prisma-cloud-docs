...
image::runtime-security/cnaf-deployment-example.png[width=650]
...
+
image::runtime-security/waas-nginx-scope.png[width=550]
...
image::runtime-security/waas-rule-example.png[width=650]
