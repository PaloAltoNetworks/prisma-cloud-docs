...
+
image::runtime-security/aws-agentless-permissions-stack.png[width=250]
+
WAAS agentless resources stack deployed in AWS:
+
image::runtime-security/aws-agentless-setup-stack.png[width=250]

* Create an AWS Cloud account under *Runtime Security > Manage > Cloud accounts* using the `Access key` from your AWS account.
+
...
+
image::runtime-security/waas-out-of-band-app-firewall.png[width=750]
...
+
image::runtime-security/waas-out-of-band-bot-protection.png[width=750]
...
+
image::runtime-security/waas-out-of-band-advanced-settings.png[width=750]
...
image::runtime-security/waas-agentless-rules.png[width=200]
...
image::runtime-security/err1-failed-to-setup-vpc.png[width=350]
...
image::runtime-security/err2-not-authorized.png[width=350]
...
image::runtime-security/err3-session-already-in-use.png[width=350]
...
image::runtime-security/err5-failed-to-find-vms.png[width=350]
