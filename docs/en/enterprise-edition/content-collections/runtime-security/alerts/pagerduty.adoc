...
. Click *New Service*.
+
image::runtime-security/pagerduty-create-new-service.png[width=100]
...
+
image::runtime-security/pagerduty-add-service-form.png[width=600]

. Click *Add Service*.
You're taken to *Integrations* tab for the Prisma Cloud service.
+
image::runtime-security/pagerduty-add-service.png[width=100]

. Copy the *Integration Key*, and set it aside.
You'll use it to configure the integration in Prisma Cloud Console.
+
image::runtime-security/pagerduty-integration-key.png[width=600]
...
+
image::runtime-security/pagerduty-review-test-alert.png[width=800]
