...
image::runtime-security/credentials-store-aws-access-key.png[width=600]
...
image::runtime-security/credentials-store-default-iam-role.png[width=800]
...
image::runtime-security/credentials-store-scan-ecr-iam-role.png[width=500]
...
image::runtime-security/credentials-store-aws-sts-relationships.png[width=600]
