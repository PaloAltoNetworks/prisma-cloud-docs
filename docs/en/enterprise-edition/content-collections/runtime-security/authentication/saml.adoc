...
+
image::runtime-security/integrate-saml-610130.png[width=600]

. On the left, click *Create new app*.
+
image::runtime-security/integrate-saml-610131.png[width=600]

. Select *SAML 2.0*, and then click *Create*.
+
image::runtime-security/integrate-saml-610135.png[width=600]

. In the *App name* field, enter *Prisma Cloud Console*, then click *Next*.
+
image::runtime-security/integrate-saml-610136.png[width=600]
...
+
image::runtime-security/integrate-saml-610150.png[width=600]

. Click on the *People* tab, and add users to the Prisma Cloud app.
+
image::runtime-security/integrate-saml-610156.png[width=600]

. Click on the *Groups* tab, and add groups to the Prisma Cloud app.
+
image::runtime-security/integrate-saml-610160.png[width=600]
