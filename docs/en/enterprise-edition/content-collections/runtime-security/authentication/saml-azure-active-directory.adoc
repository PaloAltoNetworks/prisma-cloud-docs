...
+
image::runtime-security/aad-saml-20210728-1.png[width=400]
+
. The _Compute-Console_ overview page will appear, select *2. Single sign-on* and then choose *SAML*
+
image::runtime-security/aad-saml-20210728-2.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-3.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-4.png[width=600]
+
...
+
image::runtime-security/aad-saml-20210728-5.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-6.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-7.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-10.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-12.png[width=600]
...
+
image::runtime-security/aad-saml-20210728-13.png[width=600]
+
...
+
image::runtime-security/aad-saml-20210728-8.png[width=800]
...
+
image::runtime-security/aad-saml-20210728-9.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad-saml-20210728-11.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad-saml-20210728-14.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad-saml-20210728-15.png[width=600]
+
