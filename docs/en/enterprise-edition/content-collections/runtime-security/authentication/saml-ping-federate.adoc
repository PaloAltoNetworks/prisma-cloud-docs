...
+
image::runtime-security/ping-saml-step11.png[width=600]
...
+
image::runtime-security/ping-saml-step12.png[width=600]
...
+
image::runtime-security/ping-saml-step13.png[width=600]
