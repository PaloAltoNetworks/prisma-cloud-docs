...
App-Embedded Defenders also support xref:../visibility/custom-compliance-checks.adoc[custom compliance checks].
...
+
image::runtime-security/fargate-image-comp-scan-result.png[width=600]
