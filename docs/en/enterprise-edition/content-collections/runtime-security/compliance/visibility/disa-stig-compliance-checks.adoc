...
.. Click *Save*.
+
image::runtime-security/docker-enterprise-disa-stig-container-template.png[width=600]
...
.. Click *Save*.
+
image::runtime-security/docker-enterprise-disa-stig-host-template.png[width=600]
