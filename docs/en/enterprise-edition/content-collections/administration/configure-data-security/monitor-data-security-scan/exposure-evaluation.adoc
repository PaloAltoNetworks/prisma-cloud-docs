...
+
The following Resource Events are supported:
+
* For AWS: DeleteBucket, CreateBucket, DeleteBucketPolicy, PutBucketPolicy   
* For Azure: Microsoft.Resources.ResourceDeleteSuccess, Microsoft.Resources.ResourceWriteSuccess, Microsoft.Resources.ResourceActionSuccess
...
+
The following Object Events are supported:
+
** For AWS: DeleteObject, PutObject, PutObjectAcl, PutObjectTagging, DeleteObjectTagging  
** For Azure: Microsoft.Storage.DirectoryDeleted, Microsoft.Storage.DirectoryRenamed, CreateFile, PutBlob, PutBlockList, DeleteFile, RenameFile, DeleteBlob
