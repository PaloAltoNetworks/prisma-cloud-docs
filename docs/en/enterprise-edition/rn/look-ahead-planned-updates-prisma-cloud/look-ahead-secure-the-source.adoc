...
a|In the upcoming release, Checkov CLI will upgrade to Checkov 3.0. The upgrade impacts a few known changes:

* *Level Up*: This capability will be removed. This change is non-disruptive and affects only Bridgecrew standalone sign ups.
...
* *Pyston Docker Build Deprecation*: The Pyston Docker build will be depreciated due to increasing complexities in support. The regular Checkov image will still be available for use.
