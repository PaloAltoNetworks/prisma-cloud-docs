...
+
And for Linux, xref:../install/deploy-defender/container/container.adoc[Container Defenders-Linux] or xref:../install/deploy-defender/container/host.adocHost[Defenders-Linux], running on the supported x86_64 and ARM64 Linux OS. See the xref:../install/system_requirements.adoc[system requirements].
