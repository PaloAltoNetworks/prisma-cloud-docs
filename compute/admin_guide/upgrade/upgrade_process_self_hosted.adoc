...
Note that other than during the upgrade process, the Central Console and all Supervisors must run the same product version.  Having different product versions is not supported and may lead to instability and connectivity problems.
