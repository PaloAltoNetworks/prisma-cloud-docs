...
. Continue to *App Firewall* tab, select [protections] to enable and assign them with .
+
image::waas_firewall_protections_with_banner.png[width=750]

. Continue to *Access Control* tab and select  to enable.

. Continue to *DoS protection* tab and configure  thresholds.

. Continue to *Bot protection* tab and select  to enable.
