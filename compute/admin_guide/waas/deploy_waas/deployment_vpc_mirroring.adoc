...
NOTE: With 22.12.427 version, WAAS Agentless Observers are automatically upgraded to match the Console version.
...
You must use *Refresh* to view the updated status of the deployment.
