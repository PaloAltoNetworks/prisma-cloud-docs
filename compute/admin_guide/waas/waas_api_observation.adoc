...
* Endpoints with sensitive data (icon) such as Credit card, PII, ID query parameter, Session cookies, .etc. The xref:log_scrubbing.adoc[sensitive data] is defined under *Defend > WAAS > Sensitive data*.
