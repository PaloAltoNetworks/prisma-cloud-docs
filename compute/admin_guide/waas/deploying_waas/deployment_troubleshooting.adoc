...
. A section of xref:./deployment_troubleshooting.adoc#outcomes[`troubleshooting potenial outcomes`] is provided below, along with possible causes and solutions.
