...
Select an individual pod to drill down into its vulnerability report, compliance repot, runtime anomalies, and WAAS events.
...
Filtering and search let you narrow your focus to the data of interest.
