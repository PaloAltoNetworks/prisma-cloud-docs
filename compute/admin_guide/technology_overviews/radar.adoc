...
It is designed to let you visualize and navigate through all the data across Prisma Cloud.
...
As you click on node, an overlay shows vulnerability, compliance, and runtime issues.
