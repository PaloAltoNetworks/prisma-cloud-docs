...
image::radar_cloud_pivot.png[scale=40]
...
image::radar_overlay.png[scale=40]
...
image::radar_connections.png[scale=40]
...
image::radar_zoomed_out.png[scale=50]
...
image::radar-settings.png[scale=20]
