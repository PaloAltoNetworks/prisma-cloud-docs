...
* Scanning: container registries, serverless functions, xref:~/agentless-scanning/onboard-accounts/onboard-accounts.adoc[agentless scanning], etc.
...
image::credentials_store_arch.png[width=600]
...
See xref:../configure/permissions.adoc[full permission list].
