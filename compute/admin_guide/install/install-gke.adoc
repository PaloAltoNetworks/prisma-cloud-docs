...
. With the *Kubernetes Engine Developer* service account, continue with the standard Kubernetes install procedure for the xref:./install_defender_twistcli_export_kubectl.adoc[install Kubernetes Defenders],
