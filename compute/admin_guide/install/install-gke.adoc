...
. With the *Kubernetes Engine Developer* service account, continue with the xref:./install_kubernetes.adoc#install-defender[standard installation of Kubernetes Defenders].
+
[IMPORTANT]
====
