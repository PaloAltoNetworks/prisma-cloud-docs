...
==== Prisma Cloud Console Resource Requirements
...
Prisma Cloud is supported on the following host operating systems on x86 architecture:
...
K8s native - versions 1.22, 1.23 (x86 Arch)
