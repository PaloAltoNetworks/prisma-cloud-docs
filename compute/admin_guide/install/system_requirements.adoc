...
* Runtime defense for processes only. Other categories aren't supported.
...
K8s native - versions 1.24.7, 1.25.3 (x86_64 Arch)
...
Linux on AKS 1.24.3 (containerd 1.6.+azure-4)
