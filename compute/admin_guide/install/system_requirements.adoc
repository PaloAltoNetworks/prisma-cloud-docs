...
|Amazon Linux 2
|AMI Image: amzn2-ami-kernel-5.10-hvm-2.0.20220207.1-arm64-gp2
...
Refer to the the https://man7.org/linux/man-pages/man7/capabilities.7.html[Linux capabilities man page] for more details on each capability.
