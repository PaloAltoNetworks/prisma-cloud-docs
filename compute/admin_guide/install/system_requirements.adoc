...
|Red Hat
|Red Hat Enterprise Linux 6 - host Vulnerabilities/compliance only, Red Hat Enterprise Linux 7, Red Hat Enterprise Linux 8, Red Hat Enterprise Linux CoreOS (RHCOS) versions included in supported OpenShift releases
...
|SUSE
|SLES 12 SP1 - SP5, SLES 15 SP1 - SP3
...
Podman v1.6.4, v3.3.1, v2.0.4-jenkins is supported.
...
Lightweight Kubernetes v1.21.7 and k3s1 Containerd (1.4.12-k3s1) 
...
Supported versions: 2.289, ,2.235.1, 2.319.1 verified on 2 latest versions
