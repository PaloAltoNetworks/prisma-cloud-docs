...
You can xref:../secrets/secrets_stores/cyberark_enterprise_password_vault.adoc[configure Prisma Cloud to use CyberArk EPV].
...
Native Kubernetes 1.23.8 Docker 20.10.17

Lightweight Kubernetes (k3s) 1.21.7+k3s1 (containerd 1.4.12-k3s1)
