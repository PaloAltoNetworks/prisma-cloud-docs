...
You can now install the Prisma Cloud DaemonSet Defender on your GKE *Autopilot* cluster. GKE Autopilot clusters are using *COS - containerd* nodes, therefore the DaemonSet should be configured with *CRI runtime*. 
