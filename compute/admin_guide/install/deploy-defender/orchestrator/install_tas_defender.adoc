...
* Runtime protection: Windows TAS Defenders support runtime protection for process and Linux TAS Defenders support runtime protection for process, networking, and file system.
...
+
After the deployment is complete, the deployed Defenders will appear in the table. The *Host* column shows *VM CID* of the defended Windows Diego cells and *Agent ID* of the defended Linux Diego cells.
+
...
. Configure Prisma Cloud to xref:../../../vulnerability_management/vmware_tanzu_blobstore.adoc[scan a blobstore].