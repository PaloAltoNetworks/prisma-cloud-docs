...
App-Embedded Defenders for Fargate monitor and protect your tasks at runtime to ensure they execute as designed, protecting tasks from suspicious process, network, and file system activity.

To learn when to use App-Embedded Defenders, see xref:../../install/defender_types.adoc[Defender types].

To learn more about App-Embedded Defender's runtime protection capabilities, see xref:../../runtime_defense/runtime_defense_app_embedded.adoc[runtime defense for App-Embedded].
