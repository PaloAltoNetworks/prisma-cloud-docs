...
For runtime, create new collections or use already defined collections scoped by image and container name as showed in the image below.
...
ifdef::prisma_cloud[]
. View the defender in the Prisma Cloud Console: Go to *Compute > Manage > Defenders > Manage > Defenders* and search the fargate task by adding the filters *Fargate* and *Status:Connected*.
+
...
ifdef::prisma_cloud[]
You can review the list of all Defenders connected to Console under *Compute > Manage > Defenders > Manage > Defenders*.
endif::prisma_cloud[]
...
[NOTE]
====
There is an advanced settings dialog under *Compute > Manage > Defenders > Manage > Defenders*, which lets you configure how long Prisma Cloud should wait before cleaning up disconnected Defenders.
