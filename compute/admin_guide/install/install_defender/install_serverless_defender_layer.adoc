== Serverless Defender as a Lambda layer - John
...
See xref:../system_requirements.adoc#serverless_runtimes[system requirements] for the runtimes that are supported for Serverless Defender as a Lambda layer.
