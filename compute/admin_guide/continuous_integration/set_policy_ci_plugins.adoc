...
. Enter a *Rule name* and xref:../vulnerability_management/vuln_management_rules.adoc[configure the rule].
...
. Enter a *Rule name* and configure the rule to xref:../compliance/manage_compliance.adoc[enforce compliance checks].
