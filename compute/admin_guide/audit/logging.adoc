...
Example image scan message:
  ...
  Jul 30 18:51:32 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T18:51:32.214136319Z"
    type="scan_summary" 
    log_type="image" 
...
Example container scan message:
  ...
  Jul 30 22:06:15 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T22:06:15.804842461Z"
    type="container_scan" 
    log_type="container" 
...
----
  Jul 30 22:09:53 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T22:09:53.390680962Z"
     type="scan_summary" 
     log_type="host" 
...
----
  Jul  7 23:34:09 ip-172-31-55-106 Twistlock-Console[1]:
    incident_time="2020-07-07T23:34:09.25109843Z"
    type="scan_summary"
...
----
  Jul 30 22:18:53 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T22:18:53.23838464Z"
    type="image_scan" 
...
----
 Jul 30 22:22:56 user-root Twistlock-Console[1]:
  incident_time="2019-07-30T22:22:56.871490132Z"
  type="container_scan" 
  log_type="containerCompliance" 
  compliance_id="526" 
  severity="medium" 
...
----
 Jul 30 22:09:53 user-root Twistlock-Console[1]:
  incident_time="2019-07-30T22:09:53.390585517Z"
  type="host_scan" 
  log_type="compliance" 
  compliance_id="6518" 
  severity="high" 
...
----
  May 24 07:31:02 user-root Twistlock-Console[1]:
   incident_time="2022-05-24T07:31:02.757191008Z"
   type="ci_image_scan"
...
----
  Jul 30 22:03:56 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T22:03:56.930640366Z"
    type="registry_scan" 
    log_type="vulnerability" 
...
----
  Jul 30 22:09:53 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T22:09:53.390181271Z"
    type="host_scan" 
    log_type="vulnerability" 
    vulnerability_id="46" 
...
----
  Jul 30 21:58:16 user-root Twistlock-Console[1]:
    incident_time="2019-07-30T21:58:16.80522678Z"
...
----
  Jul 30 22:41:25 user-root Twistlock-Defender[13460]:
    incident_time="2019-07-30T22:41:25.448709847Z"
...
----
  Jul 30 22:47:12 user-root Twistlock-Defender[13460]:
    incident_time="2019-07-30T22:47:12.325487039Z"
...
----
  Jul 30 23:02:23 user-root Twistlock-Defender[13460]:
    incident_time="2019-07-30T23:02:23.179494498Z"
    type="access_audit" 
    user="user"
    action="docker_ping" 
    action_type="docker" 
...
.All Deployments 
- *incident_time=[String]* request timestamp
...
----
  Jul 16 20:10:16 cnaf-nightly-build Twistlock-Defender[1947]: 
    incident_time="2020-07-16T20:10:16.706085135Z"
...
----
  Jul 30 22:06:03 user-root Twistlock-Defender[13460]:
    incident_time="2019-07-30T22:06:03.515319204Z"
    type="process" 
    pid="20859" 
    path="/bin/df" 
    interactive="false" 
...
----
  Jul 30 22:41:24 user-root Twistlock-Defender[13460]:
    incident_time="2019-07-30T22:41:24.987209676Z"
    type="incident" 
    container_id="73c2e8267f9b80ea152403c36c377476d24e43e211bb098300a317b3d1c472e4" 
    image_name="ubuntu:18.04" 
    host="user-root.c.cto-sandbox.internal"
...
----
  Mar  5 00:26:42 user-root Twistlock-Defender[22797]:
    incident_time="2018-03-05T00:26:42.894707831+02:00"
    type="incident"
