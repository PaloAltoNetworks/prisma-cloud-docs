...
Additionally, you can implement your own compliance checks with xref:./custom_compliance_checks.adoc[scripts].
...
* Twistlock Labs compliance checks for xref:./prisma_cloud_compliance_checks.adoc[containers, images, Istio, and Linux hosts].
