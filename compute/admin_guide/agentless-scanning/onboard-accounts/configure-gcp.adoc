...
Using a shared VPC requires additional permissions set on the shared VPC host project, go the the xref:../../configure/permissions.adoc#gcp-agentless[GCP agentless permissions] page for more details.
+
[source]
----
