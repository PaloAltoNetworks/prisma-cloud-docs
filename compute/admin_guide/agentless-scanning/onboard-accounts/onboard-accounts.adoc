...
The egress port you should allow is tcp/8083` for the Prisma Cloud Compute Edition. Review the egress port configuration needed to https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/get-started-with-prisma-cloud/enable-access-prisma-cloud-console[enable access to the Prisma Cloud console]
...
Ideally, your security group denies all incoming traffic and allows one egress port. Review the egress port configuration needed to https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin/get-started-with-prisma-cloud/enable-access-prisma-cloud-console[enable access to the Prisma Cloud console].
