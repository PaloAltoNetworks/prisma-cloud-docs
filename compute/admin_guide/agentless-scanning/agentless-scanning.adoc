...
NOTE: Agentless scanning is not supported on Windows platforms.  Linux platforms are supported with caveats (see: https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-compute/install/system_requirements).
