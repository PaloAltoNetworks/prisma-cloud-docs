...
. Install xref:../install/install_onebox.adoc[Onebox].
...
+
* xref:../install/install_kubernetes.adoc[Console on Kubernetes]
* xref:../install/install_openshift_4.adoc[Console on OpenShift]
* xref:../install/install_kubernetes.adoc#install-defender[Defender DaemonSets on Kubernetes]
* xref:../install/install_openshift_4.adoc#install-defender-openshift[Defender DaemonSets for OpenShift]
