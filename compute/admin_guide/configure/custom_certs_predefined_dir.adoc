...
* xref:../install/install_kubernetes.adoc#_install_defender[Defender DaemonSets on Kubernetes]
* xref:../install/install_openshift_4.adoc#_install_defender[Defender DaemonSets for OpenShift]
