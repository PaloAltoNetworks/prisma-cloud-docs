...
* You can assign public IPs in your account while creating security groups to connect to the Prisma Cloud Console. This is not needed if you are using a proxy.
