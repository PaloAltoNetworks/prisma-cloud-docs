...
.. HTTP Proxy: To connect to the Prisma Cloud Console through a proxy, enter the full proxy address that Prisma Cloud scanners must use. If you are using an HTTPS proxy, provide the Certificate Authority (CA) certificate fro TLS.
+
