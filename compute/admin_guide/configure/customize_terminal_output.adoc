...
You can create custom rules to audit your Kubernetes cluster and alert when a rule is violated. Refer to the xref:../audit/kubernetes_auditing.adoc[Kubernetes auditing] documentation.
