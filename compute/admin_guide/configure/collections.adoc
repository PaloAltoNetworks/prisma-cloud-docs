...
[NOTE]
====
If a user is assigned multiple system roles, either directly or through group inheritance, then the user is granted the higest role, and access to the assigned collections of all the groups to which the user belongs.
