...
When restoring a Console running on Fargate perform the steps:

[.procedure]
. Create a new xref:../install/install_console_on_fagate.adoc[Console Fargate task].

. Create Console's first administrative account and license.
