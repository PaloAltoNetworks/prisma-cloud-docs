...
It's important to make the distinction between the inner and outer interfaces because a number of Compute components directly address the inner interface, namely:
