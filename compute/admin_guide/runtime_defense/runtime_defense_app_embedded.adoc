...
For more information, see xref:../install/deploy-defender/app-embedded/config_app_embedded_fs_protection.adoc[configuring the default setting for file system protection].
...
* xref:../install/deploy-defender/app-embedded/install_app_embedded_defender_fargate.adoc[Install App-Embedded Defender for Fargate]
