...
You can find the OpenSCAP report at https://cdn.twistlock.com/docs/attachments/openscap_console_30_02_123_stig.html[here]
...
You can find the OpenSCAP report at https://cdn.twistlock.com/docs/attachments/openscap_defender_30_02_123_stig.html[here].
