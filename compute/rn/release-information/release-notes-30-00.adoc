...
This includes a change in request and response schema. For more information, see parameter changes in https://pan.dev/compute/api/30-00/get-cloud-discovery/[30.00], https://pan.dev/compute/api/22-12/get-cloud-discovery/[22.12], and https://pan.dev/compute/api/22-06/get-cloud-discovery/[22.06].
