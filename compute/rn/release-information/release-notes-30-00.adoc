...
The number of reports retrieved is limited to a maximum of 250, and the default value is 50.
...
The request and response schema of this API have been updated to implement this change. The `entities` in *GET, /api/vVERSION/cloud/discovery* is moved to another endpoint *GET, /api/v1/cloud/discovery/entities*.

IMPORTANT: To retrieve more than 50 reports, you must update your scripts to use the *limit* and *offset* parameters as required.
