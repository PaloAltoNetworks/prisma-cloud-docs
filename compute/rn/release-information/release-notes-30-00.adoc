...
This includes a change in request and response schema. The `entities` in *GET, /api/vVERSION/cloud/discovery* is moved to another endpoint *GET, /api/vVERSION/cloud/discovery/entities*.
