...
To download the Prisma Cloud Compute Edition release tarball from the Palo Alto Network Customer Support Portal(CSP):

1. Log in to the https://support.paloaltonetworks.com/[Palo Alto Network Customer Support Portal].
