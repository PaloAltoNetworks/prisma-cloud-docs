...
=== Deprecation Notice for API


//CWP-49167
Effective in 30.02, the CNNS capability is deprecated and will be removed in future releases.

As a result, the following endpoints are deprecated:
