...
image::containerRuntimeRule-Processes.png[scale=10]

image::containerRuntimeRule-Networking.png[scale=10]
...
image::custom-ca-certificate.png[scale=10]
...
image::alert-trigger-profile.png[scale=5]
...
image::application-host-control-compliance-rule.png[scale=15]
...
image::waas_custom_rules_min_defender.png[scale=15]
...
image::waas-access-control-exception.png[scale=15]
...
image::waas-agentless-rule.png[scale=20]

image::waas-vpc-configuration.png[scale=10]
...
+
image::38112-fix-status-version.png[scale=15]
