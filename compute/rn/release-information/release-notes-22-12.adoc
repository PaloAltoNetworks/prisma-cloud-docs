...
image::36812-agentless-results.png[scale=25]
...
image::rn-37326-vuln_explorer_image_details.png[scale=1]
...
image::containerRuntimeRule-Processes.png[scale=25]

image::containerRuntimeRule-Networking.png[scale=25]
...
image::custom-ca-certificate.png[scale=25]
...
image::alert-trigger-profile.png[scale=25]
...
image::exclude-base-image-vulnerabilities.png[scale=25]
...
image::36697-vulnerability-report-package.png[scale=25]
...
image::application-host-control-compliance-rule.png[width=100]
...
image::waas-access-control-exception.png[scale=25]
...
image::waas-custom-rules-jwt-functions.png[width=200]
...
image::waas-oob-tls.png[width=200]
...
image::waas-agentless-rule.png[width=200]

image::waas-vpc-configuration.png[width=200]
...
+
image::38289-cve-fix-date.png[width=200]
+
...
+
image::38112-fix-status-version.png[width=200]
