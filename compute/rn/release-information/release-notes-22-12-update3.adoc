...
* Added permissions context to Defender upgrades.
When you select to Upgrade all Defenders under *Manage >  Defenders > Deployed Defenders*, you can only upgrade the Defenders that are eligible for upgrade and for which you have the permissions to upgrade, based on your Prisma Cloud role.
This change applies to upgrades for Host and Container Defenders on Linux and Windows.
