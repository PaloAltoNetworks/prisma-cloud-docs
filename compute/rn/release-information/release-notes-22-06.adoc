...
* Vulnerability Fixes
+
This release contains updates to resolve CVEs in the following packages:
+
*Console & Defender*:
+
** Upgraded Go Lang version to 1.18.3. 
+
With this update, vulnerabilities in https://groups.google.com/u/1/g/golang-announce/c/TzIC9-t8Ytg[1.18.2], https://groups.google.com/u/1/g/golang-announce/c/Y5qrqw_lWdU?pli=1[1.18.1], and https://groups.google.com/u/1/g/golang-announce/c/oecdBNLOml8[1.18.0] are fixed.

** Removed mongodb-tools binaries 
+
To fix Go Lang https://groups.google.com/u/1/g/golang-announce/c/oecdBNLOml8[1.16.7] vulnerabilities
