...
With this IS update, if you are on Prisma Cloud Compute Edition v22.06, you must upgrade to Kepler Update 3 (22.06.223) that will be available the week of November 6, 2022, before the Lagrange release.
