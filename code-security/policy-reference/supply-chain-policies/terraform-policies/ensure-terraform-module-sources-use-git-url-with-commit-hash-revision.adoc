...
These approach is problematic, because the versions are not immutable and can be easily changed, which makes the code vulnerable to a Supply Chain Attack.
