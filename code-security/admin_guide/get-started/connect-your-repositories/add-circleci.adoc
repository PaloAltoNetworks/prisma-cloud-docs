...
After a code security scan access *Code Security > Projects* to view the latest integrated CircleCI repository to xref:../../scan-monitor/monitor-fix-issues-in-scan.adoc[Suppress] or xref:../../scan-monitor/monitor-fix-issues-in-scan.adoc[Fix] the policy misconfigurations.
