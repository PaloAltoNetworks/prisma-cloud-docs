...
+
You can optionally choose to access Checkov plugin from *IntelliJ IDEA > Preferences > Plugins > Marketplace* and then search for the Checkov plugin to install.
+
image::intellij-5.png[width=600]
+
A Checkov scan runs each time you access a file on IntelliJ.
