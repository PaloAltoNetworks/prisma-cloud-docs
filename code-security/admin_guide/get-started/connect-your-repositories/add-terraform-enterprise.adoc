...
.. Edit the source path `{PATH_TO_FILE}` to the location of the `prismacloud.sentinel` file that you will create in the next step. This is typcally just `./prismacloud.sentinel`. Then select *Next*.
