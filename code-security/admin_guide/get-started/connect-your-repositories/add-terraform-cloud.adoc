...
.. (Optional) Edit the default source path `./prismacloud.sentinel` to the location of another sentinel file in the code and then select *Next*. We recommend using the default value.
