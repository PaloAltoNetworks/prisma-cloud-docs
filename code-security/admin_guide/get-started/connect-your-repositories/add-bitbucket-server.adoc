...
Bitbucket Server is combination of Git server and a web interface product built with Apache Maven. The usage of Bitbucket Server is similar Git however, you can use the Bitbucket Server web application to control the read and write permissions to your code on Git.
