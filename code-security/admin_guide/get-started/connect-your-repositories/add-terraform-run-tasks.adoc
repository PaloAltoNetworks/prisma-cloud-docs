...
+
For a workspace integration of run tasks you need https://www.terraform.io/cloud-docs/users-teams-organizations/permissions#general-workspace-permissions[Manage All Workspaces and Manage Run Tasks permissions]. This enables Prisma Cloud to configure run tasks in the environment and scan runs.
