...
+
The console displays Code Editor as a default view with an example of a YAML template.
...
+
For every test, the console displays up to 30 test results. Each time you test your code, Prisma Cloud runs a scan across all integrated repositories to give you a list of up to 30 resources that can be impacted by your custom code.
+
image::code-editor-3.png[width=600]
+
Access any test result to view more details on the impacted resource and misconfiguration.
+
...
+
If there are errors in your custom code during a test, the console will display a solution.
+
In this example, you see solution for the errors from your code.
+
image::code-editor-5.png[width=600]

.. Select *Validate and Next* to access *Compliance Standards* while completing the process of creating a custom Build-time check policy.
+
