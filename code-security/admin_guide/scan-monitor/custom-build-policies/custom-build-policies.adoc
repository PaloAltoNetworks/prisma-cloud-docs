...
+
Optionally, if you have enables run subtype, you need to add CLI Command and Validate to know if the specified command can be used for the new policy.
+
image::custom-build-11.png[width=600]
