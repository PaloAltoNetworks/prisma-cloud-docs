...
Prisma Cloud performs periodic scans on each integrated repository of onboarded Version Control Systems (VCS) and CI/CD pipelines to find infrastructure misconfigurations, open source vulnerabilities, license compliance violations, and exposed secrets.
...
|Fix Pending
|An issue awaiting remediation fix as a PR in your VCS console.
