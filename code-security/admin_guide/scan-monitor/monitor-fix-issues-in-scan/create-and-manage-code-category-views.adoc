...
Prima Cloud provides eight default views of Overview, IaC misconfiguration, Vulnerabilities, Secrets, Licenses, Build Integrity, VCS Pull Requests and CI/CD Runs.

In addition you can create customized views to prioritize misconfigurations and vulnerabilities in your scan results originating from your integrated repositories.
