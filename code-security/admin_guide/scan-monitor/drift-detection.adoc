...
+
See <<monitor-drift-alerts-on-prisma-cloud>>[Monitor Drift Detection Alerts] on Prisma Cloud to learn more about managing and monitoring alerts.

[#monitor-drift-alerts-on-prisma-cloud]
=== Monitor Drift Alerts on Prisma Cloud
