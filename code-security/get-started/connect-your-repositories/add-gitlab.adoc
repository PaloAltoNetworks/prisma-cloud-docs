...
. *New account successfully configured* message appears after you have successfully set up the configurations and then select *Done* to complete adding GitLab to Prisma Cloud Code Security.
+
