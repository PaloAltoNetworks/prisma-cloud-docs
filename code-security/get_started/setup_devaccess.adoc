...
Prisma Cloud includes a predefined Developer role where the user has the least privilege permissions who need to log in to the Prisma Cloud administrative console.
