...
|xref:bc-aws-alert-2.adoc[Route 53 DNS service modifications are not detected]
|checkov id not found in file bc-aws-alert-2.adoc
|severity not found in file bc-aws-alert-2.adoc
...
|xref:bc-aws-general-108.adoc[Ensure RedShift Cluster is encrypted by KMS using a customer managed Key]
|checkov id not found in file bc-aws-general-108.adoc
|severity not found in file bc-aws-general-108.adoc
...
|xref:bc-aws-general-35.adoc[Instances with scheduled reboots are not rescheduled or manually rebooted]
|checkov id not found in file bc-aws-general-35.adoc
|severity not found in file bc-aws-general-35.adoc


|xref:bc-aws-general-36.adoc[PGAudit is not enabled on RDS Postgres instances]
|checkov id not found in file bc-aws-general-36.adoc
|severity not found in file bc-aws-general-36.adoc
...
|xref:ensure-aws-redshift-cluster-is-encrypted-by-key-management-service-kms-using-a-customer-managed-key-cmk.adoc[AWS RedShift Cluster is not encrypted by Key Management Service (KMS) using a Customer Managed Key (CMK)]
|checkov id not found in file ensure-aws-redshift-cluster-is-encrypted-by-key-management-service-kms-using-a-customer-managed-key-cmk.adoc
|severity not found in file ensure-aws-redshift-cluster-is-encrypted-by-key-management-service-kms-using-a-customer-managed-key-cmk.adoc
...
|checkov id not found in file ensure-fx-ontap-file-system-is-encrypted-by-kms-using-a-customer-managed-key-cmk.adoc
|severity not found in file ensure-fx-ontap-file-system-is-encrypted-by-kms-using-a-customer-managed-key-cmk.adoc
...
|xref:ensure-kms-have-rotation-policy.adoc[Rotation for customer created CMKs is disabled]
|checkov id not found in file ensure-kms-have-rotation-policy.adoc
|severity not found in file ensure-kms-have-rotation-policy.adoc
...
|xref:ensure-that-secret-manager-secret-is-encrypted-using-kms.adoc[Unencrypted Secret Manager secret]
|checkov id not found in file ensure-that-secret-manager-secret-is-encrypted-using-kms.adoc
|severity not found in file ensure-that-secret-manager-secret-is-encrypted-using-kms.adoc
...
|xref:general-1.adoc[EC2 instances do not have tags]
|checkov id not found in file general-1.adoc
|severity not found in file general-1.adoc
...
|xref:general-19.adoc[Unused Elastic IPs are present]
|checkov id not found in file general-19.adoc
|severity not found in file general-19.adoc


|xref:general-2.adoc[An unused EBS volume is not attached to an instance]
|checkov id not found in file general-2.adoc
|severity not found in file general-2.adoc


|xref:general-20.adoc[Unused network interfaces are present]
|checkov id not found in file general-20.adoc
|severity not found in file general-20.adoc


|xref:general-21.adoc[Unused Elastic Load Balancers are present]
|checkov id not found in file general-21.adoc
|severity not found in file general-21.adoc
...
|xref:general-5.adoc[AWS CloudFront distribution is using insecure SSL protocols for HTTPS communication]
|checkov id not found in file general-5.adoc
|severity not found in file general-5.adoc
