...
|xref:ensure-cognitive-services-disables-public-network-access.adoc[Cognitive Services does not disable public network access]
|checkov id not found in file ensure-cognitive-services-disables-public-network-access.adoc
|severity not found in file ensure-cognitive-services-disables-public-network-access.adoc
...
|xref:ensure-that-mysql-server-disables-public-network-access.adoc[My SQL server enables public network access]
|checkov id not found in file ensure-that-mysql-server-disables-public-network-access.adoc
|severity not found in file ensure-that-mysql-server-disables-public-network-access.adoc
