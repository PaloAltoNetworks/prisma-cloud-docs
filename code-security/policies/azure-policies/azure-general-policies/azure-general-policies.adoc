...
|xref:bc-azr-general-12.adoc[A retention period of less than 90 days is not specified]
|checkov id not found in file bc-azr-general-12.adoc
|severity not found in file bc-azr-general-12.adoc
...
|xref:bc-azr-general-4.adoc[Send email notification for high severity alerts is not enabled]
|checkov id not found in file bc-azr-general-4.adoc
|severity not found in file bc-azr-general-4.adoc
